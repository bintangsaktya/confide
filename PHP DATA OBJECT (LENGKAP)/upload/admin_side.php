...
<div class="alert alert-notice" role="alert">
  <center>
   ...
   <div class="row">
    <div class="col-md-3 col-sm-3">
     ...
     <button type="button" name="group_chat" id="group_chat" class="btn btn-primary">Kontrol Group Chat</button>
    </div><br>
  ...
  <p>Halo sob! saat ini Confide memberikan layanan chat gratis sementara ! </p>
    ...
    <div class="col-md-4 col-sm-4">
     <p align="right">Anda Login Sebagai ADMIN - <a href="admin_logout.php">Logout</a></p>
    </div>
   </div>
